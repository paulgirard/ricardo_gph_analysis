...
// /!\ All attributes stored as sets must be casted when reading JSON data and thus must be present in this array
export const attributesStoredAsSets = ["originalReporters", "labels", "originalPartners"];
